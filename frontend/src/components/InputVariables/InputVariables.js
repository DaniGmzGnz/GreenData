...
//   console.log("ReactTable", props);
  ...
  return (
    <>
    <br/><br/><br/>
      <label class="subtitulo-input">Información de Consumo de Vehículos</label>
      <br />
...
const ReactTable2 = React.memo(({ updateFunc}) => {
    ...
    return (
      <>
      <br/><br/><br/>
        <label class="subtitulo-input">Información sobre Fugas de Gas Fluorinado</label>
        <br />
        <StyledTable {...getTableProps()}>
          <thead>
            {headerGroups.map(headerGroup => (
...
const ReactTable3 = React.memo(({ updateFunc}) => {
    ...
    <>
    <br/><br/><br/>
        <label class="subtitulo-input">Información Generación de Residuos</label>
        <br />
        <StyledTable {...getTableProps()}>
        <thead>
            {headerGroups.map(headerGroup => (
  ...
  const onSubmit =  (values, instance) => {
   ...
   fetch('http://greendata.herokuapp.com/flask/hello', requestOptions)
         ...
         .then(response => {
            ...
            props.onResultChange(response.result)
         })
  };
